...
SELECT COUNT(u.user_id) AS 'Số lượng like', u.user_id, u.full_name, u.email
FROM users AS u
...
VALUES
    ...
    ('Falafel Wrap', 8.49, 'falafel_wrap.jpg', 'Middle Eastern wrap with falafel, hummus, and veggies.', 12),
...
-- (tìm user không like không đánh giá, không order)
